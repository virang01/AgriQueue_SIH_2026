    ...
    <div className="max-w-2xl mx-auto my-12 px-4 font-body text-gov-text bg-white animate-fade-in-up">
      <div className="bg-white rounded-2xl border border-gov-border hero-container-shadow overflow-hidden border-t-4 border-t-gov-red">
        <div className="bg-gradient-to-br from-white via-red-50/20 to-[#FDF6F6] p-6 text-center space-y-1 border-b border-gov-border relative overflow-hidden">
          ...
          <h2 className="text-xl font-bold font-heading text-gov-text">{t('auth.register_title')}</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-bold font-heading text-gov-text border-b border-gov-border pb-1">1. Personal & Contact Details</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 bg-gov-gray border border-gov-border rounded-lg text-sm text-gov-text focus:ring-2 focus:ring-gov-red focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-3 py-2.5 bg-gov-gray border border-gov-border rounded-lg text-sm font-semibold text-gov-red focus:ring-2 focus:ring-gov-red focus:outline-none font-heading"
                >
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-bold font-heading text-gov-text border-b border-gov-border pb-1">2. Location & Land Holding Details</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-bold font-heading text-gov-text border-b border-gov-border pb-1">3. Bank Account for DBT Payment</h3>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
